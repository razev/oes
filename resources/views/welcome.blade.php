...
<header class="header header-inverse h-fullscreen pb-80" data-parallax="{{ asset('assets/img/bg-man.jpg ') }}" data-overlay="8">
    ...
    <div class="row h-full">
        ...
        <h1 class="display-4 hidden-sm-down">OES</h1>
        <h1 class="hidden-md-up">THE BEST WEB ONLINE EDUCATION SCREENCASTS ON THE INTERNET</h1>
        <br>
        <p class="lead text-white fs-20 hidden-sm-down"><span class="fw-400">OES</span> is an awesome web based learning<br>subscription based SaaS  application powered with Vuejs and <span class="mark-border">Laravel 5.5   </span>.</p>
